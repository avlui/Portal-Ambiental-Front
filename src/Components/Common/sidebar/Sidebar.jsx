import "./sidebar.css";
import DropListE from "../dropList/DropListEmpresas";
import DropListR from "../dropList/DropListResiduos";
        ...
        axios.get("http://localhost:5000/puntos").then((res) => {
            ...
            setOpcionesEmpresa(
                empresas.map((empresa) => (
                    <MenuItem key={empresa._id} value={empresa}>
                        {empresa}
                    </MenuItem>
                ))
            );
            ...
            <div className="sidebarWrapper">
                <div className="sidebarMenu">
                    ...
                    <ul className="sidebarList">
                        <DropListE
                            param={opcionesEmpresa}
                            getEmpresaSelection={getEmpresaSelection}
                        />
                    </ul>
                </div>
                <div className="sidebarMenu">
                    ...
                    <ul className="sidebarList">
                        <DropListR
                            param={opcionesResiduo}
                            getResiduoSelection={getResiduoSelection}
                        />
                    </ul>
                </div>
            </div>
